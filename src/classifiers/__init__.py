...
Scripts numérotés (R1) à exécuter dans l'ordre :
    ...
    02_knn.py                M1 — k-NN sur embeddings concat (vision + text)
    03_svm.py                M2 — LinearSVC + Platt calibration sur embeddings
    04_rf.py                 M3 — RandomForest sur embeddings (interprétable)
    05_mlp.py                M4 — MLP head sur embeddings (non-linéaire neural)
