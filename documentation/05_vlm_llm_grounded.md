...
- **Best-effort, jamais bloquant** (R15) : `None` si pas de photo, pas d'image catalogue, ou VLM
...
- **Abstraction `LLMWriter`** : `OpenRouterWriter` (réel) **ou** `MockLLMWriter` (D-013) — bascule
...
- ✅ **Best-effort partout** (R15) : le validateur et l'extraction ne cassent jamais le flux.
