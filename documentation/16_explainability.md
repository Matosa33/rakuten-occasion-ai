...
| **t-SNE** | projection 2D des embeddings (Arctic texte + SigLIP vision) **colorés par catégorie** → vérifie la **séparation visuelle** des 4 catégories | `TSNE_N_SAMPLES = 5000`, `perplexity = 30` |
...
**Limites assumées:**
- **SHAP calculé sur M3 (Random Forest)**, or M3 a été **écarté** du serving (inefficace en haute dim): SHAP explique donc un modèle *représentatif* à base d'arbres, pas
