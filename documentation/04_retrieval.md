...
### c) Garde-fous OOD — 3 niveaux (`src/retrieval/03_ood_guardrails.py`, D-017)
...
- En usage réel, la requête vendeur est **courte** → cosinus systématiquement plus bas qu'un
  ...
  (l'humain est le validateur, R19) :
...
- ✅ **OOD calibré** côté précision → on gère l'inconnu honnêtement (anti-hallucination, R19).
