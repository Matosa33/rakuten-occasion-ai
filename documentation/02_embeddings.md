...
- **Normaliser systématiquement** est une règle d'or : si une base vectorielle est configurée
...
- **Débat actuel** (arXiv 2403.05440, *« Is cosine-similarity really about similarity? »*) : le
...
Un module **unique** (source de vérité) avec 5 fonctions *sans état* (R3) qui **ne mutent jamais**
les entrées :
- `l2_normalize` — avec le **garde-fou R11** : si une norme est < `eps` (1e-12), on renvoie un
...
**Solide :**
- ✅ Normalisation L2 **systématique avec garde-fou** (R11) → exactement la bonne pratique
...
> *Approfondissement (Cycle 32-bis) : ce rapport sert de modèle de profondeur pour les 12 autres
